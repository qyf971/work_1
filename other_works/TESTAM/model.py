...
class TESTAM(nn.Module):
    ...
    TESTAM model
    """
    def __init__(self, num_nodes, dropout=0.3, in_dim=10, out_dim = 1, hidden_size = 32, layers = 3, prob_mul = False, max_time_index = 288, **args):
        ...
        self.end_conv = nn.Conv2d(24, 1, kernel_size = (1, 1))
    ...
    def forward(self, input, gate_out = False):
        ...
        out = self.end_conv(out.transpose(1, 2)).transpose(1, 2)
        # print(out.shape)
        return out

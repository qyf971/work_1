...
from other_works.STGAGRTN.GAT import GAT
import numpy as np
...
class TemporalTransformer(nn.Module):
    ...
    def forward(self, input_temporal_transformer):
        ...
        input_encoder = input_temporal_transformer
...
class GRULayer(nn.Module):
    ...
    def forward(self, x):
        ...
        output, _ = self.short_gru(x)

        output = output.reshape(B, N, t, -1)
...
class STGAGRTN(nn.Module):
    ...
    def forward(self, x):
        ...
        output_temporal_transformer = self.dropout(self.norm2(self.temporal_transformer(output_spatial_block) + output_spatial_block))

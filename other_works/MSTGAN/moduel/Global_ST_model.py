...
from other_works.MSTGAN.components.Bilinear_Temporal_Attention import Temporal_Attention_layer
from other_works.MSTGAN.components.Bilinear_Spatial_Attention import Spatial_Attention_layer

...
from other_works.AGCRNCell import AGCRNCell
...
class AGCRN(nn.Module):
    def __init__(self, num_nodes, input_dim, rnn_units, output_dim, horizon, num_layers, default_graph, cheb_k, embed_dim):

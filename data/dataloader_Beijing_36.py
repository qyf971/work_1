...
class Dataloader_Beijing_36(object):
    ...
    def inverse_transform(self, data):
        if self.target == 'PM25':
            scaler_path = '../dataset/Beijing_36/train_val_test_data/scaler_PM25.npy'
        elif self.target == 'PM10':
            scaler_path = '../dataset/Beijing_36/train_val_test_data/scaler_PM10.npy'
        else:
